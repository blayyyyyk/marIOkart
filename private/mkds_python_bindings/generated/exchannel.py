...
from private.mkds_python_bindings.generated.channel import *
...
class union__anonymous_at__Users_blakemoody_dev_mariokart_ml_mkds_c_external_include_nitro_snd_common_exchannel_h_238_5(Union):
    _fields_ = [
        ('data', c_void_p32),
        ('duty', SNDDuty),
    ]
...
class SNDExChannel(Structure):
    _fields_ = [
        ...
        ('callback_data', c_void_p32),
        ('nextLink', POINTER32(SNDExChannel)),
    ]
...
SNDExChannelCallback = c_void_p32
