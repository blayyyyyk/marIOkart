...
class PXIFifoMessage(Union):
    _fields_ = [
        ('e', struct__unnamed_at__Users_blakemoody_dev_mariokart_ml_mkds_c_external_include_nitro_pxi_common_fifo_h_137_5),
        ('raw', u32),
    ]
RTCPxiResult = c_int
PXIFifoCallback = c_void_p32
PXIFifoStatus = c_int
PXIFifoEmtpyCallback = c_void_p32
PXIFifoTag = c_int

class struct__unnamed_at__Users_blakemoody_dev_mariokart_ml_mkds_c_external_include_nitro_pxi_common_fifo_h_137_5(Structure):
    _fields_ = [
        ('tag', u32),
        ('err', u32),
        ('data', u32),
