...
class struct__unnamed_at__Users_blakemoody_dev_mariokart_ml_mkds_c_rnet_h_71_9(Structure):
    _fields_ = [
...
class struct__unnamed_at__Users_blakemoody_dev_mariokart_ml_mkds_c_rnet_h_119_9(Structure):
    _fields_ = [
        ...
        ('field74E', (u8 * 4)),
        ('gap752', (u8 * 2)),
        ('dwcSendBuffer', POINTER32(rnet_dgram_t)),
        ('packetNextState', u32),
        ('flags', u16),
        ('gap75E', (u8 * 1)),
        ('field75F', u8),
