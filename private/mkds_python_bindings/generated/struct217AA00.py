...
class struct__unnamed_at__Users_blakemoody_dev_mariokart_ml_mkds_c_struct217AA00_h_5_9(Structure):
    _fields_ = [
        ('nickName', (u16 * 10)),
        ('emblem', (u8 * 512)),
        ('hasEmblem', u8),
...
class struct__unnamed_at__Users_blakemoody_dev_mariokart_ml_mkds_c_struct217AA00_h_36_9(Structure):
    _fields_ = [
        ('field0', u32),
        ('field4', u32),
        ('field8', u32),
