...
from private.mkds_python_bindings.generated.sound3 import *
...
class struct__unnamed_at__Users_blakemoody_dev_mariokart_ml_mkds_c_systemData_h_31_9(Structure):
    _fields_ = [
        ('field0', u32),
