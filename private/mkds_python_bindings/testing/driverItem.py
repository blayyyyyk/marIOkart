...
from private.mkds_python_bindings.testing.item import *
...
class it_driver_itemslot_t(Structure):
    _fields_ = [
        ('itemConfigId', c_int),
        ('driverItemStatus', u32), #POINTER(it_driver_item_status_t)),
        ('itemCount', c_int),
        ('fieldC', c_int),
        ('timeout', u16),
        ('field12', u16),
        ('items', (POINTER(it_item_inst_t) * 3)),
        ('field20', c_int),
        ('field24', c_int),
    ]
...
class it_driver_item_status_t(Structure):
    _fields_ = [
        ...
        ('field18', u32), #POINTER(it_driver_item_status_t)),
        ('field1C', c_int),
        ('field20', c_int),
        ('field24', c_int),
        ('field28', c_int),
        ...
        ('field1EC', u16),
        ('ipoi', u32), #POINTER(mdat_itempoint_t)),
        ('field1F4', c_int),
        ('driverId', u16),
        ('driver', u32), #POINTER(driver_t)),
        ('driverIndex', c_int),
