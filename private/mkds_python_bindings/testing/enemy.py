...
from private.mkds_python_bindings.testing.mapData import *
...
class enemy_item_state_t(Structure):
    _fields_ = [
        ('slotItemTimeout', u16),
        ('dragItemTimeout', u16),
        ('slotItemParams', u32), #POINTER(enemy_item_params_t)),
        ('dragItemParams', u32), #POINTER(enemy_item_params_t)),
        ('fieldC', c_int),
        ('lxPressed', c_int),
        ('dpadUpPressed', c_int),
...
class struc_316_epoi(Structure):
    _fields_ = [
        ('nextEpoi', u32), #POINTER(mdat_enemypoint_t)),
        ('curEpoi', u32), #POINTER(mdat_enemypoint_t)),
        ('direction', VecFx32),
        ('areaEpoi', u32), #POINTER(mdat_enemypoint_t)),
        ('areaEpoiValid', BOOL),
        ('driverId', u16),
        ('field1E', u8),
        ('field1F', u8),
...
class struc_313_mepo(Structure):
    _fields_ = [
        ('nextMepo', u32), #POINTER(mdat_mgenemypoint_t)),
        ('curMepo', u32), #POINTER(mdat_mgenemypoint_t)),
        ('direction', VecFx32),
        ('areaMepo', u32), #POINTER(mdat_mgenemypoint_t)),
        ('areaMepoValid', BOOL),
    ]
