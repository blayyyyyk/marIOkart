...
class struct__anonymous_at__Users_blakemoody_dev_mariokart_ml_mkds_c_src_stub_includes_nitro_gx_gx_bgcnt_h_116_5_(Structure):
    _fields_ = [
        ('priority', u16),
        ('charBase', u16),
        ('mosaic', u16),
...
class struct__anonymous_at__Users_blakemoody_dev_mariokart_ml_mkds_c_src_stub_includes_nitro_gx_gx_bgcnt_h_132_5_(Structure):
    _fields_ = [
        ('priority', u16),
        ('charBase', u16),
        ('mosaic', u16),
...
class struct__anonymous_at__Users_blakemoody_dev_mariokart_ml_mkds_c_src_stub_includes_nitro_gx_gx_bgcnt_h_148_5_(Structure):
    _fields_ = [
        ('priority', u16),
        ('charBase', u16),
        ('mosaic', u16),
...
class struct__anonymous_at__Users_blakemoody_dev_mariokart_ml_mkds_c_src_stub_includes_nitro_gx_gx_bgcnt_h_164_5_(Structure):
    _fields_ = [
        ('priority', u16),
        ('_reserve1', u16),
        ('charBase', u16),
...
class struct__anonymous_at__Users_blakemoody_dev_mariokart_ml_mkds_c_src_stub_includes_nitro_gx_gx_bgcnt_h_182_5_(Structure):
    _fields_ = [
        ('priority', u16),
        ('_reserve1', u16),
        ('mosaic', u16),
...
class struct__anonymous_at__Users_blakemoody_dev_mariokart_ml_mkds_c_src_stub_includes_nitro_gx_gx_bgcnt_h_198_5_(Structure):
    _fields_ = [
        ('priority', u16),
        ('_reserve1', u16),
        ('mosaic', u16),
