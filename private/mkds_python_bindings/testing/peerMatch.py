...
from private.mkds_python_bindings.testing.struct217AA00 import *
from private.mkds_python_bindings.testing.types import *


class net_menu_dgram_header_t_(Structure):
    _fields_ = [
        ('opcode', u32),
        ('size', u32),
        ('aidSrc', u8),
...
class net_menu_profile_dgram_t_(Structure):
    _fields_ = [
...
class net_menu_config_t_(Structure):
    _fields_ = [
        ('field0', (u32 * 4)),
        ('field10', (u32 * 4)),
        ('selectedCourse', u32),
...
class net_menu_dgram_t_(Structure):
    _fields_ = [
        ('header', net_menu_dgram_header_t),
        ('data', net_menu_config_t),
    ]

class net_match_status_t_(Structure):
    _fields_ = [
        ('state', u32),
...
class net_field_12F0_t_(Structure):
    _fields_ = [
        ('gap0', (u8 * 12)),
        ('inetStatus', u32),
    ]

class net_match_property_t_(Structure):
    _fields_ = [
        ('value', u32),
        ('key', (c_char * 16)),
        ('field14', u8),
...
class net_state_field_B2C_t_(Structure):
    _fields_ = [
        ('control', (u8 * 3508)),
        ('fieldDB4', u8),
        ('fieldDB5', u8),
