from src.config import ROM_PATH
from src.utils.recording.extract_ghost import data_to_dict, has_ghost, get_normal_ghost_data, COURSE_ABBREVIATIONS
from src.utils.recording import convert_to_dsm
